    ...
    <div>
      <div className="row pt-md-4 pb-4">
        ...
        <div className="col-md-7 pr-md-5 pt-5 pb-5">
          <h3>Wellcome to <span className="font-weight-bold">XXX</span></h3>
          <p>Lorem ipsum dolor sit amet consectetur adipiscing elit tellus et aliquet, tempor tristique donec
